...
var ExtractBootstrapPlugin = new ExtractTextPlugin('css/bootstrap.css');

module.exports = function (options) {
  var entry, jsLoaders, plugins, cssLoaders, bootstrapLoader;
  ...
  if (options.prod) {
    ...
    bootstrapLoader = ExtractBootstrapPlugin.extract('style-loader', 'css-loader!postcss-loader!sass-loader');
    // Plugins
    ...
    bootstrapLoader = 'style-loader!css-loader!postcss-loader!sass-loader';
